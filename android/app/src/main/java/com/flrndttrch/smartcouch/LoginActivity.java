...
import com.flrndttrch.smartcouch.rest.BasicAuthInterceptor;
...
//        populateAutoComplete();
    ...
    private Callback<UserResponse> userCallback = new Callback<UserResponse>() {
        ...
        public void onFailure(Call<UserResponse> call, Throwable throwable) {
            Toast.makeText(LoginActivity.this, R.string.error_users, Toast.LENGTH_SHORT).show();
...
//    }
    ...
    private boolean isAccountValid(String account) {
        ...
        //TODO: Send REST request if account exists
        return true;
    }
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            if (mAccount != null && mPassword != null) {
                DjangoService djangoService =
                        ServiceGenerator.createService(DjangoService.class, mAccount, mPassword);
                Call<UserResponse> call = djangoService.listUsers();
                call.enqueue(userCallback);
            }
